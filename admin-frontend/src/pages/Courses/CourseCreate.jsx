...
const CourseCreate = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const cleanMentorsWithKeys = mentorsWithKeys
                .map(m => ({
                    name: (m.name || "").trim(),
                    role: (m.role || "").trim(),
                    workExpYears: m.workExpYears === "" ? null : Number(m.workExpYears),
            ...
            if (cleanMentorsWithKeys.length > 0) {
                await api.put(`/admin/courses/${courseId}`, { ...payload, mentors: cleanMentorsWithKeys });
            }
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div>
                            <div className="flex justify-between items-center mb-4">
                                ...
                                <button
                                    type="button"
                                    onClick={() => setMentors([...mentors, { name: "", role: "", workExpYears: "", teachExpYears: "", about: "", imageKey: "", imageFile: null, imagePreviewUrl: "" }])}
