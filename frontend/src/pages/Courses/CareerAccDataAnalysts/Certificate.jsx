      ...
      >
        ...
        >
          ...
          <div className="text-center">
            <img
              src="/images/Career Accelerator_ Data Analytics_certificate.png"
              alt="Certificate"
              className="w-full max-w-[500px] mx-auto cursor-zoom-in"
              onClick={() => setShowCertificate(true)}
            />
            <div
              className="mt-[10px] text-[16px] lg:text-[18px] text-[#2563eb]
        ...
        {showCertificate && (
          ...
          >
            <div
              className="w-full max-w-[576px] h-[576px] bg-white rounded-[10px]
                   relative p-[8px] shadow-[0_8px_25px_rgba(0,0,0,0.3)]"
              onClick={(e) => e.stopPropagation()}
            >
              <span
                className="absolute top-[6px] right-[10px]
                     text-[22px] font-bold text-[#2563eb]
                     cursor-pointer z-[100000]"
                onClick={() => setShowCertificate(false)}
              >
                ✕
              </span>
