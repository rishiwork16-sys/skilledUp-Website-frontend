          ...
          <div className="w-full lg:w-[45%] border border-[#c6c8cc] rounded-[8px] overflow-hidden self-start">
            ...
            `}
              >
                ...
                <h4
                  className={`mt-[2px] text-[13px] lg:text-[13.5px] leading-[1.2] font-semibold /* Added font-semibold */
