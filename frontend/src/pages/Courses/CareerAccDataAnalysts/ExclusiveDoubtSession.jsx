...
const ExclusiveDoubtSession = ({ openForm }) => {
  return (
    <SectionContainer bgColor="#F5F6FB">
      <div
        className="flex flex-col lg:flex-row items-center lg:items-center gap-8 lg:gap-[80px]"
        style={{
          fontFamily:
            '"Canva Sans","Inter","Poppins",system-ui,-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif',
        }}
      >
        {/* LEFT IMAGE BLOCK - FIXED FOR RESPONSIVE */}
        <div className="relative w-full lg:w-[520px] flex-shrink-0">
          <div className="relative flex flex-col gap-6 lg:gap-[42px] items-center lg:items-start">
            <img
              ...
              alt=""
              className="w-full lg:w-[4in] h-[2.2in] rounded-[18px] bg-[#fefefe] object-cover
               border border-[#c6c8cc] shadow-[0_12px_34px_rgba(0,0,0,0.14)]"
            />
            ...
            <img
              ...
              alt=""
              className="w-full lg:w-[4in] h-[2.2in] rounded-[18px] bg-[#fefefe] object-cover
               border border-[#c6c8cc] shadow-[0_12px_34px_rgba(0,0,0,0.14)] hidden lg:block"
            />
          </div>

          {/* OVERLAP IMAGE - FIXED POSITIONING */}
          <img
            src="https://akm-img-a-in.tosshub.com/indiatoday/images/story/202005/SE-1-3-Online-Study-May11-3.jpeg?size=1200:675"
            alt=""
            className="absolute top-1/2 left-1/2 w-[5in] h-[2.2in]
             -translate-x-1/2 -translate-y-1/2
             rounded-[18px] object-cover border border-[#c6c8cc]
             bg-[#fefefe] shadow-[0_18px_44px_rgba(0,0,0,0.18)]
             z-[5] hidden lg:block"
          />
        </div>
        ...
        <div className="flex-1 max-w-[580px] text-center lg:text-left">
          ...
          <button
            onClick={openForm}
            className="mt-[22px] px-[26px] py-[11px] bg-[#264f9b] text-white
             text-[16px] font-semibold rounded-[10px]
             transition hover:bg-[#191917]"
          >
            Talk to an Expert
          </button>
        </div>
