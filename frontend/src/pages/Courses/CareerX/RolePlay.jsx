  ...
  const roles = [
    {
      ...
      description: "Design and implement scalable applications using AI & ML algorithms.",
    },
    {
      title: "Data Analyst",
      description: "Develop application for fixing data quality issues and get data insights.",
    },
    {
    ...
    {
      title: "Data Engineer",
      description: "Design, build and maintain data infrastructure for large-scale applications.",
    },
    {
      title: "Junior Data Scientist",
      description: "Work on analysis, model building & data cleansing to solve business problems.",
    },
    {
