...
const StudentsWorkAt = () => {
  ...
  return (
    <SectionContainer bgColor="#f3f4f6">
      <div id="students-work-section" className="font-['Inter']">
        ...
        <div className="bg-white p-6 lg:p-[40px] rounded-[12px] shadow-[0_5px_20px_rgba(0,0,0,0.09)]">
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4 lg:gap-[30px]">
            {companyLogos.map((logo, i) => (
              <div
                key={i}
                className="bg-white border border-[#e5e7eb] rounded-[8px] h-[70px] lg:h-[80px] flex items-center justify-center p-3 lg:p-[18px_12px] transition hover:shadow-[0_4px_14px_rgba(0,0,0,0.12)] hover:-translate-y-[2px]"
              >
                <img
                  src={logo}
                  alt="Company Logo"
