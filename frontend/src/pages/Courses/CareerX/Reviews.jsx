    ...
    <SectionContainer bgColor="white">
      <div className="flex flex-col lg:flex-row gap-[30px] lg:gap-[60px] items-center justify-between">
        <div className="flex-[0_0_45%] flex flex-col justify-center">
          ...
          <button
            onClick={openForm}
            className="mt-[28px] inline-flex items-center gap-[12px] w-fit px-[22px] py-[12px] rounded-[8px] border-[3px] border-[#2f238f] text-[#2f238f] font-bold text-[15px] lg:text-[16px] transition-all duration-150 hover:-translate-y-[2px] hover:bg-[rgba(47,35,143,0.06)]"
          >
        ...
        <div className="flex-[0_0_45%] w-full flex justify-center lg:justify-end">
          <div className="relative w-full max-w-[1000px] pt-[66%] rounded-[16px] overflow-hidden bg-[#f3f3f3] shadow-[0_6px_18px_rgba(20,20,30,0.08)] border border-black/10">
            <img
