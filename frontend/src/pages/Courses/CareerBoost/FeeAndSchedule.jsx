...
const FeeAndSchedule = ({ selectedMode, setSelectedMode }) => {
  const timeSlots = [
    {
      id: 1,
      mode: 'online',
          ...
          >
            ...
            <div className="flex flex-col lg:flex-row justify-between items-start gap-8 lg:gap-6">
              ...
              <div className="w-full lg:w-[35%] text-center lg:text-left lg:pl-4">
                ...
                <button
                  className="mt-[22px] px-[26px] py-[11px] bg-[#264f9b] text-white text-[16px] font-semibold rounded-[10px] transition hover:bg-[#191917] w-full lg:w-auto"
                >
                  Enroll Now
                </button>
              </div>
