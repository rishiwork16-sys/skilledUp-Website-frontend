  ...
  return (
    <SectionContainer bgColor="bg-gray-50">
      <div style={{
        ...
        <div
          className="bg-white p-6 lg:p-[25px] rounded-[15px] shadow-[0_4px_20px_rgba(0,0,0,0.08)] grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-[30px]"
        >
          {/* LEFT IMAGE */}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 lg:gap-[15px]">
            <div className="bg-[#f7fbff] border border-[#e2eefc] p-4 lg:p-[18px] rounded-[12px] flex items-center gap-4 lg:gap-[15px]">
            ...
            <div className="bg-[#f7fbff] border border-[#e2eefc] p-4 lg:p-[18page 1] rounded-[12px] flex items-center gap-4 lg:gap-[15px]">
              <span className="text-[28px] lg:text-[32px]">👥</span>
              <p className="m-0 text-sm lg:text-base">
